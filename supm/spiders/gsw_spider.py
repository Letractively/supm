...
class GScholarSpider(CrawlSpider):
    ...
    rules = (Rule(SgmlLinkExtractor(allow='/citations?hl=en&user=.+&pagesize=100&view_op=list_works&cstart=[0-9]+')),
    ...
    def parse_item(self, response):
        ...
        item['title'] = ''.join(hxs.select('//div[@id="title"]/a/text()').extract()).encode('utf-8')
