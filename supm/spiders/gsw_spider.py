...
class GScholarSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        item['authors'] = ''.join(hxs.select('//div[@class="g-section cit-fieldbox"]/div[@class="cit-dl"]/div[@class="g-section"]/div[@class="cit-dd"]/text()').extract()).encode('iso-8859-1','ignore')
